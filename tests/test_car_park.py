...
class TestCarPark(unittest.TestCase):
    def setUp(self):
        self.car_park = CarPark("log.txt", "123 Example Street", 100)
    ...
    def test_log_file_created(self):
        ...
        self.new_carpark = CarPark(log_file, "123 Example Street", 100)
    ...
    def test_car_logged_when_entering(self):
        new_carpark = CarPark("new_log.txt", "123 Example Street", 100)  # TODO: change this to use a class attribute or new instance variable
